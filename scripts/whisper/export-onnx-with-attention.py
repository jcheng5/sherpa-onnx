...
# Import shared utilities from base export script.
# We use importlib because the filename has a hyphen which isn't valid for
# regular Python imports.
# Note: This import also applies the AudioEncoder.forward monkey-patch.
...
add_meta_data = _export_onnx.add_meta_data
AudioEncoderTensorCache = _export_onnx.AudioEncoderTensorCache
